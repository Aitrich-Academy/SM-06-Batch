    ...
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                switch (choice)
                {
                    case 1: ob1.category = petCategory.Dog; break;
                    case 2: ob1.category = petCategory.Cat; break;
                    case 3: ob1.category = petCategory.Bird; break;
                    case 4: ob1.category = petCategory.Fish; break;
                    case 5: ob1.category = petCategory.Reptile; break;
                    case 6: ob1.category = petCategory.Other; break;
            ...
            Console.WriteLine("Pet Category :{0}", ob1.category);
            Console.ReadLine();
